...
export default function ChecklistPage() {
  const stored = () => { try { return JSON.parse(localStorage.getItem('ml_checklist')||'{}') } catch { return {} } }
  ...
  const persist = (s) => { localStorage.setItem('ml_checklist', JSON.stringify(s)); setState(s) }
