...
export default function ProgressPage({ trades, stats }) {
  const [goals,   setGoals]   = useState(() => { try { return {...DEFAULT_GOALS,...JSON.parse(localStorage.getItem('ml_goals')||'{}')} } catch { return DEFAULT_GOALS } })
  ...
  const saveGoals = () => {
    ...
    localStorage.setItem('ml_goals', JSON.stringify(saved))
